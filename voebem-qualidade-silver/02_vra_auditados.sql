-- -------------------------------------------------------------------------------
-- Passo 2 - o contrato de dados, escrito como código.
--
...
-- "= mede contra: as duas devolvem o mesmo numero e voce reporta 30 mil voos com
...
COMMENT 'Contrato de dados de silver.vra. Nove expectations, todas em modo warn: mede qualidade sem descartar linha. A silver segue com a contagem original.'
